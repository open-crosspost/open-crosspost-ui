      ...
      <div className="min-h-[80vh]">
        ...
        <div className="flex flex-col items-center justify-center px-4 py-10 sm:py-16 md:py-20">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            {/* CTA */}
            <div className="flex w-full flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 pt-4 sm:pt-6 max-w-md sm:max-w-none mx-auto">
              <ConnectToNearButton />
        ...
        <div className="border-y-2 border-primary bg-white dark:bg-black py-4 overflow-hidden">
          <div className="flex w-max items-center animate-marquee whitespace-nowrap">
            <div className="flex shrink-0 items-center">
              <span className="mx-5 sm:mx-8 text-sm sm:text-lg font-bold inline-flex items-center gap-1.5 sm:gap-2">
