    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="border-none bg-transparent p-0 shadow-none sm:max-w-4xl">
        <motion.div
          ...
          className="relative w-[calc(100%-0.5rem)] sm:w-full max-w-4xl mx-auto border-2 border-gray-800 dark:border-gray-600 bg-white dark:bg-black shadow-[2px_2px_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_rgba(255,255,255,0.3)] sm:shadow-[4px_4px_0_rgba(0,0,0,1)] dark:sm:shadow-[4px_4px_0_rgba(255,255,255,0.3)] flex flex-col max-h-[85vh]"
        >
